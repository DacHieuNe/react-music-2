...
function Home() {
  ...
  if (typeof data === "string")
    return (
      <div className="home">
        Vì vấn đề về CORS. Bạn hãy bật devtool và tắt disable cache đi. Cảm ơn
        bạn .
      </div>
    );
  return (
    <div className="home">
      ...
      <div className="card-container">
        {typeof data === "object"
          ? data.topicEvent.map((item, index) => (
              <CardList
                name={item.groupName.split("_")[0]}
                listPlaylist={item.listPlaylist}
                key={index}
                type="playlist"
              />
            ))
