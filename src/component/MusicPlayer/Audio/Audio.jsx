...
function Audio() {
  ...
  return (
    <div className="music-player-controls">
      <audio
        src={
          playingSong.streamUrls.length > 0 &&
      ...
      <div className="music-player-controls__time">
        <div className="music-player-controls__time__current" ref={timeCurrent}>
          00:00
        </div>
        ...
        <div
          className="music-player-controls__time__duration"
          ref={timeDuration}
        >
      ...
      <div className="music-player-controls__buttons">
        <div
          className="music-player-controls__buttons__item"
          ref={randomBtn}
          onClick={() => {
        ...
        <div
          className="music-player-controls__buttons__item center"
          ref={playBtn}
          onClick={() => {
