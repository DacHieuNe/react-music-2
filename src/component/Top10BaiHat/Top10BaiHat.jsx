...
function Top10BaiHat(props) {
  ...
  function findElement(e) {
    ...
    const key = element
      .closest(".top10-baihat-content__list__item")
    ...
    <div className="top10-baihat">
      ...
      <div className="top10-baihat-content">
        <ul className="top10-baihat-content__list">
          {data.map((item, index) => (
            <li
              className="top10-baihat-content__list__item"
              key={index}
              data-key={item.key}
              onClick={
                item.streamUrls.length === 0
                  ? () =>
                      alert(
                        "API đã giấu link mp3. Hãy vào những Playlist để nghe. Cảm ơn bạn"
                      )
                  : (e) => {
            ...
            >
              <div
                className="top10-baihat-content__list__item__img"
              ...
              <div className="top10-baihat-content__list__item__options">
                <div
                  className="top10-baihat-content__list__item__options__item"
                  onClick={(e) => {
                    e.stopPropagation();
